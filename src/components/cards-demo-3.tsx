...
export default function CardDemo() {
  return (
    <Card className="bg-neutral-900 border-none h-[35vh] relative ">
      <video
        src="/Project-1.mp4"
        autoPlay
        loop
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 ">
        <div className="flex items-center justify-between ">
          <CardTitle className="text-neutral-200">Brainly</CardTitle>
          <div className="flex items-center gap-2">
            <Link
              href="https://github.com/PiyushRathoree/Brainly"
        ...
        <CardDescription className="text-neutral-400">
          A Second Brain application where you can save your notes, ideas, and
          thoughts.
        </CardDescription>
      </div>
    </Card>
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-4 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-100 shadow shadow-neutral-600 group",
        className
      )}
    >
      {children}
